...
(function ($) {
    ...
    $(document).ready(function(){
        function validatePasswords() {
            ...
            var confirmPassword = $('#registerForm #confirm_password').val();
            if (password !== confirmPassword || password === '' || confirmPassword === '') {
                $('#registerForm #registerButton').attr('disabled', 'disabled');
            } else {
                $('#registerForm #registerButton').removeAttr('disabled');
            }
        }

        $('#registerForm #password, #registerForm #confirm_password').on('keyup', validatePasswords);
